...
df['temp_'] = pd.cut(df['temperature'], bins=temp_bins, labels=['very low', 'low',  'neutral', 'high', 'very high', 'extremely high'])
df['irradiance_toa_'] = pd.cut(df['irradiance_toa'], bins=irradiance_toa_bins, labels=['very low', 'low',  'neutral',  'high', 'very high', 'extremely high'])
df['irradiance_surface_'] = pd.cut(df['irradiance_surface'], bins=irradiance_surface_bins, labels=['very low', 'low',  'neutral',  'high', 'very high', 'extremely high'])
df['precipitation_'] = pd.cut(df['precipitation'], bins=precipitation_bins, labels=['very low', 'low',  'neutral',  'high', 'very high', 'extremely high'])
df['snowfall_'] = pd.cut(df['snowfall'], bins=snowfall_bins, labels=['very low', 'low',  'neutral', 'high', 'very high', 'extremely high'])
df['snow_depth_'] = pd.cut(df['snow_depth'], bins=snowdepth_bins, labels=['very low', 'low',  'neutral',  'high', 'very high', 'extremely high'])
df['cloud_cover_'] = pd.cut(df['cloud_cover'], bins=cloud_cover_bins, labels=['very low', 'low',  'neutral', 'high', 'very high', 'extremely high'])
df['air_density_'] = pd.cut(df['air_density'], bins=air_density_bins, labels=['very low', 'low',  'neutral',  'high', 'very high', 'extremely high'])
df['energy_'] = pd.cut(df['Total Energy Use from Electricity (MW)'], bins=energy_bins, labels=['very low', 'low', 'neutral',  'high', 'very high', 'extremely high'])
